...
export default function DataTable(props) {
  ...
  const SurveyAfterChoose = useSelector(state=>state.SurveyAfterChoose.SurveyAfterChoose)
  ...
  const handleSendSurvey =()=>{
    const SurveySendAfterCheck = {...SurveyAfterChoose ,email_send : survey.received_to,id_survey_send:survey.id_survey_send}
  
    console.log("🚀 ~ file: DataTable.js ~ line 163 ~ handleSendSurvey ~ SurveySendAfterCheck", SurveySendAfterCheck)
    axios({
   ...
   const renderButtonSend =(survey)=>{
       console.log("🚀 ~ file: DataTable.js ~ line 172 ~ renderButtonSend ~ survey", survey)
      let xml ; 
      if(survey.send_to){
            xml = ""
      }else{
